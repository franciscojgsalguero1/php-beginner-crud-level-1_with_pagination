<!-- 
    /*
        ...
        * Fecha Inicio: 19/11/2020
        * Fecha Fin: 21/11/2020
    ...
    <body>
        ...
        <div class="container">
            ...
            <?php
                ...
                // isset() is a PHP function used to verify if a value is there of not
                ...
                try {
                    ...
                    $query = "SELECT id, name, description, price, uploads FROM products WHERE id = ? LIMIT 0, 1";
                    ...
                    $price = $row['price'];
                    $image = htmlspecialchars($row['uploads'], ENT_QUOTES);
            ...
            <!-- we have our html table where the record will be displayed -->
