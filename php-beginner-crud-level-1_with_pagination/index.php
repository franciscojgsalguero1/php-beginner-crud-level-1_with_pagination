                    ...
                    echo "<table class='table table-hover table-responsive table-bordered'>"; // start table
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<tr>";
                                ...
                                echo "<td>";
                                    // read one record
                                    echo "<a href='/TodoCursoPHP/CodeFaninja/CRUD%20for%20Beginners/php-beginner-crud-level-1_with_pagination/read_one.php?id={$id}' class='btn btn-info m-r-1em'>Read</a>";
                                    
                                    // we will use this links on next part of this post
                                    echo "<a href='/TodoCursoPHP/CodeFaninja/CRUD%20for%20Beginners/php-beginner-crud-level-1_with_pagination/update.php?id={$id}' class='btn btn-primary m-r-1em'>Edit</a>";
                                    
                                    // we will use this links on next part of this post
                                    echo "<a href='/TodoCursoPHP/CodeFaninja/CRUD%20for%20Beginners/php-beginner-crud-level-1_with_pagination/delete.php?id={$id}' onclick=delete_user({$id})' class='btn btn-danger'>Delete </a>";
                                echo "</td>";
                            echo "</tr>";
                        }
